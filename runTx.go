...
const IP string = "192.168.1.42" // Pih1
//	const IP string = "192.168.1.37"	// Pih2
...
//签名发送交易，返回hash值
func TxSign(Wfrom, Wto *Wallet, value int64) string {
	...
	strValue = "2000000000000000000000000"
...
func main() {
	...
	newh2 := NewWallet("n1aXC9QBsvBhUgt4WkEBeLxsbJeJV8DUWDr")
	newh1.getaccountstate()
	newh2.getaccountstate()
	//return
	newh1.hash = UnlockTx(newh1, newh2, 1)
	//newh1.hash = TxSign(newh1, newh2, 1)
	iSecond := 0
